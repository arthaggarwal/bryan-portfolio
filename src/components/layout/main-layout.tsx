...
// Display size: width="545" height="550"
const TripleHexagonClusterSVG = () => (
  <svg
    viewBox="-6.67 0 290.46 293.34" // s=80, pointy-topped, adjusted viewBox
    width="545" // Increased size
    height="550" // Increased size
    xmlns="http://www.w3.org/2000/svg"
    fill="hsl(var(--primary))" // Filled with primary color
    aria-hidden="true"
  >
...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className={cn("flex flex-col min-h-screen overflow-x-hidden")}>
      ...
      <NavigationBar />
      <main className="flex-grow px-4 sm:px-6 lg:px-8 py-8 relative z-[1]">
        {children}
      </main>
