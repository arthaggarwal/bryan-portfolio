...
export default function HomePage() {
  useEffect(() => {
    // Make body non-scrollable when homepage mounts
    document.body.style.overflow = 'hidden';
    // Cleanup function to restore scrolling when component unmounts
    return () => {
      document.body.style.overflow = ''; // Revert to CSS-defined overflow
    };
      ...
      <section className="container mx-auto flex flex-col md:flex-row items-center gap-10 md:gap-16">
        <div className="md:w-3/5 space-y-5 text-center md:text-left">
          ...
          <p className="text-lg sm:text-xl text-foreground/80 leading-relaxed">
            I am passionate about performing research that is meaningful and unique. I aspire to use my knowledge and love for STEM to create a substantial impact on the world and change lives for the better.
          </p>
